...
const CATEGORIES = [
  ...
  { id: "feature", label: "✨ Feature Request", desc: "An idea for something new or improved" },
  { id: "design", label: "🎨 Design Feedback", desc: "Visual, UX, or layout suggestions" },
  { id: "performance", label: "⚡ Performance", desc: "Speed, loading, or technical issues" },
  { id: "content", label: "📝 Content", desc: "About the links, AI, or content quality" },
    ...
    return (
      <div className="ocean-bg min-h-screen pt-6 pb-28 px-4 flex items-center justify-center">
        <div className="glass-card p-12 text-center max-w-md w-full rounded-2xl">
          ...
          <h2 className="text-2xl font-black gradient-text mb-3" style={{ fontFamily: "Poppins, Inter, sans-serif" }}>
            Thanks for the feedback!
          </h2>
          <p style={{ color: "rgba(0,200,220,0.55)", lineHeight: 1.6 }}>
            Your message has been received. We read every piece of feedback and use it to improve ZhuuVIP for everyone.
          </p>
          <button
    ...
    <div className="ocean-bg min-h-screen pt-6 pb-28 px-4">
      <div className="max-w-2xl mx-auto">
        <div className="text-center mb-10">
          ...
          <h1 className="text-4xl font-black gradient-text mb-2" style={{ fontFamily: "Poppins, Inter, sans-serif" }}>Feedback</h1>
          <p style={{ color: "rgba(0,200,220,0.5)" }}>Share your thoughts, ideas, and suggestions to improve ZhuuVIP.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button
            ...
            className={`w-full py-4 rounded-full font-bold text-base transition-all duration-300 ${message.trim() && !sending ? "neon-btn-solid" : ""}`}
            style={!message.trim() || sending ? { background: "rgba(0,20,40,0.4)", border: "1px solid rgba(0,200,220,0.1)", color: "rgba(0,200,220,0.3)", cursor: "not-allowed" } : {}}
          >
