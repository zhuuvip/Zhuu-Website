  ...
  const handleSaveLink = async () => {
    ...
    try {
      if (editingLinkId !== null) {
        await updateLink.mutateAsync({ id: editingLinkId, data: { title: linkForm.title, url: linkForm.url, icon: linkForm.icon || undefined, sortOrder: linkForm.sortOrder, isActive: linkForm.isActive } });
      } else {
